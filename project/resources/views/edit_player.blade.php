...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>მოთამაშის ინფორმაციის რედაქტირება</h3>
                </div>
                <div class="col-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}"> <i data-feather="home"></i></a></li>
                        <li class="breadcrumb-item active">მოთამაშის ინფორმაციის რედაქტირება</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>ინფორმაციის რედაქტირება</h5>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" action="{{ route('update_player', $info->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="validationCustom02" type="text"
                                                ...
                                                name="player_saxeli" value="{{ $info->player_saxeli }}">
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="validationCustom02" type="number"
                                                placeholder="შეიყვანეთ პირადი ნომერი" name="player_piradi_nomeri" value="{{ $info->player_piradi_nomeri }}">
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select" id="validationTooltip04" required="" name="passport_type">
                                                            @if($info->passport_type == 1)
                                                            <option value="1" selected>პირადობა</option>
                                                            @endif
                                                            @if($info->passport_type == 2)
                                                            <option value="2" selected>პასპორტი</option>
                                                            @endif
                                                            @if($info->passport_type == 3)
                                                            <option value="3" selected>საზღვარგარეთის პასპორტი</option>
                                                            @endif
                                                            <option disabled="" value="">- აირჩიეთ მოწმობის ტიპი -</option>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control" id="validationCustom02" type="text"
                                                placeholder="შეიყვანეთ პირადი ნომერი" value="{{ $info->piradobis_nomeri }}" name="piradobis_nomeri">
                                        </div>

                                        <br>
                                        <button class="btn btn-primary" type="submit" data-bs-original-title=""
                                            title="">რედაქტირება</button>
                                </form>
                            </div>
                        </div>
                    </div>
